                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row text-center">
                            ...
                            <a href="post/delete/<?php echo $row->post_id; ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                            <a href="post/delete/<?php echo $row->post_id; ?>" class="btn btn-primary mt-1"><i class="fas fa-trash"></i> Delete Full</a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach; ?>
